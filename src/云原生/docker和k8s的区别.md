...
![程序和环境](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711881781641.jpeg)
...
![基础镜像是什么](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711881824726.jpeg)
...
![容器镜像](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/image-20240830130252602.png)
...
![github仓库](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711881944211.jpeg)
...
![Registry是什么](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711882017085.jpeg)
...
![容器是什么](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711882051189.jpeg)
...
![Docker和虚拟机的区别](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711882143210.jpeg)
...
![Docker是C/S软件架构](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/image-20240830130353326.png)
...
![Docker daemon内部架构](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/image-20240830130409343.png)
...
![docker build执行逻辑](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711882342439.jpeg)

### docker pull/push

如果你执行的是 docker pull 或 push 之类的镜像推拉操作，Job 则会跟外部的 `Docker Registry` 交互，将镜像上传或下载。

![docker pull/push执行逻辑](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711882355306.jpeg)

### docker run

如果你执行的是 docker run 命令，Job 就会基于镜像文件调用 containerd 组件，驱使 runC 组件创建和运行容器。

![docker run执行逻辑](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/image-20240830130504068.png)
...
![Docker到底是什么](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711882385493.jpeg)
...
![Docker compose原理](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/image-20240830130732507.png)
...
![Docker swarm是什么](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/image-20240830130707814.png)
...
![pod内部](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/1711882525008.jpeg)
...
![容器编排引擎的含义](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/image-20240830130632902.png)
...
![Docker和k8s](https://cdn.jsdelivr.net/gh/Cutewr/blogimage@main/img/image-20240830130617426.png)
